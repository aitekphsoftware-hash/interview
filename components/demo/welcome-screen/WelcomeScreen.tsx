...
const welcomeContent: Record<Template, { title: string; description: string; prompts: string[] }> = {
  'hr-interviewer': {
    ...
    description: 'Experience a simulated job interview with an AI. It will ask you questions and assess your responses.',
    prompts: [
      "I'm ready for my interview.",
      "Let's start the interview for the Product Manager role.",
    ],
  },
  'customer-support': {
